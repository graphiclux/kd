        ...
        <table class="variations" cellspacing="0">
            <tbody>
                ...
                foreach ($attributes as $name => $options) : $loop++; ?>
                    <tr>
                        <td class="value"><label for="<?php echo sanitize_title($name); ?>"><?php echo wc_attribute_label($name); ?></label><select id="<?php echo esc_attr(sanitize_title($name)); ?>" name="attribute_<?php echo sanitize_title($name); ?>">
                            ...
                            if (sizeof($attributes) == $loop)
                                echo '<a class="reset_variations" href="#reset" title="' . __('Clear selection', 'woocommerce') . '">x</a>';
                            ?></td>
                    </tr>
                <?php endforeach; ?>
