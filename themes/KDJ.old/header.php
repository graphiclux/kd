        ...
        <div class="wrapper">
            <header id="header">
                ...
                <?php if (get_field('free_shipping_text', 'option')) { ?>
                    <div class="header_shipping_ad"><?php the_field('free_shipping_text', 'option'); ?></div>
                <?php } ?>
            </header><!--/header-->
            <div id="body">

<!-- BEGIN PRIVY WIDGET CODE -->
<script type='text/javascript'> var _d_site = _d_site || '90B1449970C8B93A166588D1'; </script>
