...
class SV_WC_Tracking_Integration extends WC_Integration {
	...
	public function __construct( $id, $title, $description ) {
		...
		if ( $this->has_event( 'completed_purchase' ) ) {
			...
			// catch BACS and check orders
			add_action( 'woocommerce_order_status_on-hold_to_processing', array( $this, 'completed_purchase' ) );
			add_action( 'woocommerce_order_status_on-hold_to_completed',  array( $this, 'completed_purchase' ) );

			// catch orders manually set to processing/completed by admins
