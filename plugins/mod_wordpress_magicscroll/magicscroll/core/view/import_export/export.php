<?php
    function WordPress_MagicScroll_wp_export($set="all", $core_sett, $constructor_sett) {
        ...
        $license = magictoolbox_WordPress_MagicScroll_get_data_from_db();
        if ($license) {
        ...
        $filename = $sitename . 'wordpress.magicscroll.' . date( 'Y-m-d' ) . '.xml';
