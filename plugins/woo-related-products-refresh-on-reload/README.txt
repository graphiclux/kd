...
== Description ==
 ...
 You can now display fresh, random Woocommerce related products on every single product page load
  (in a slider or not) based on current product's category,product tags or product attributes.
