...
if(!defined('MagicZoomPlusModuleCoreClassLoaded')) {
    ...
    class MagicZoomPlusModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus WooCommerce module version v6.7.0 [v1.6.64:v5.2.4] -->';
        ...
        function loadDefaults() {
            $params = array(
				...
				"use-wordpress-images"=>array("id"=>"use-wordpress-images","group"=>"Use Wordpress images","order"=>"6","default"=>"No","label"=>"Use Wordpress created images","type"=>"array","subType"=>"radio","values"=>array("Yes","No"),"scope"=>"module"),
