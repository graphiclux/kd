...
function WooCommerce_MagicZoomPlus_send_stat($action = '') {
    ...
    if('working' == 'v6.7.0' || 'working' == 'v5.2.4') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magiczoomplus&license=commercial&tool_version=v5.2.4&module_version=v6.7.0&platform_name=woocommerce&platform_version={$platformVersion}&url={$url}";
