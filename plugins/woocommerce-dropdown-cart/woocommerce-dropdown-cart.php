<?php
/*
Plugin Name: Woocommerce Shopping Bag Dropdown - CUSTOM CODE ADDED
Description: DO NOT UPDATE WITHOUT DEVELOPER APPROVAL. A widget plugin for WooCommerce to display the cart at top of page based on https://wordpress.org/plugins/woocommerce-dropdown-cart/
Author: Graphic Lux
Version: 99.9
...
class WooCommerce_Widget_DropdownCart extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        $item_text = __('', 'woocommerce-ddc');
        $items_text = __('', 'woocommerce-ddc');
